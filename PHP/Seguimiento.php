...
require_once ("gestion_listas.php");
	...
	$query = 'SELECT * FROM ESTAENLISTASEG WHERE OID_US='. $usuario["OID_US"];
	...
	<script>
		...
		<?php
			...
			<?php }	else { ?>
						...
						<a href="Seguimiento.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
		...
		<form method="post" action="accion_eliminar_seguimiento.php" style="display: inline" onsubmit="return validarOIDInmueble">
